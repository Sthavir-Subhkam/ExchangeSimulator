...
constexpr uint16_t kTxnPriceVolModificationAck = 20406;
constexpr uint16_t kTxnOrderEntryRequestTrimmed = 20000;
constexpr uint16_t kTxnOrderEntryAckTrimmed = 20400;
constexpr uint16_t kTxnOrderModificationRequestTrimmed = 20040;
constexpr uint16_t kTxnOrderModificationAckTrimmed = 20402;
constexpr uint16_t kTxnOrderCancellationRequestTrimmed = 20070;
constexpr uint16_t kTxnOrderCancellationAckTrimmed = 20404;
...
constexpr uint16_t kTxnQuickAckOrderEntryResponse = 20401;
constexpr uint16_t kTxnQuickAckOrderModificationResponse = 20403;
constexpr uint16_t kTxnQuickAckOrderCancellationResponse = 20405;
constexpr uint16_t kTxnQuickAckPriceVolModificationResponse = 20407;

constexpr uint16_t kTxnOrderEntryTrimmed = kTxnOrderEntryRequestTrimmed;
constexpr uint16_t kTxnOrderModificationTrimmed = kTxnOrderModificationRequestTrimmed;
constexpr uint16_t kTxnOrderCancellationTrimmed = kTxnOrderCancellationRequestTrimmed;
